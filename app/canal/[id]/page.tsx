...
// EPG muda a cada poucos minutos (PROJECT.md §53).
...
export async function generateMetadata({
  ...
  if (!detail) {
    // NOTA (limitação conhecida do Next.js App Router, verificada
    // manualmente nesta sessão): por causa de app/loading.tsx e
    // app/canal/[id]/loading.tsx criarem um Suspense boundary acima
    // desta rota, o Next já envia o shell com status 200 antes deste
    // notFound() resolver — o status HTTP real da resposta continua
    // 200, mesmo a UI de "não encontrado" sendo exibida corretamente.
    // Sem nenhum loading.tsx na árvore, o 404 real volta a funcionar
    // (confirmado testando). Optamos por manter os skeletons (§45/§47
    // exigem explicitamente) em vez de remover loading.tsx só para
    // corrigir o status code — ver README > Troubleshooting.
    notFound();
  }

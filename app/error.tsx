...
export default function Error({
  ...
  useEffect(() => {
    // Nunca expor a mensagem de erro crua na UI (PROJECT.md §28,
    // SECURITY.md) — só logar internamente, com o digest do Next
    // para correlacionar com os logs do servidor.

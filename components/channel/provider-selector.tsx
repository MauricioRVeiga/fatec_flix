...
/**
 * Seleção de servidor (PROJECT.md §37). Componente controlado — o
 * estado de qual provider está selecionado vive em `ChannelPlayer`,
 * que é quem precisa dele pra escolher a URL do iframe.
 */
